...
<h1 id="so-if-i-change-this-what">So if I change this, what?</h1>
...
<pre><code>&lt;p&gt;something is aded in here&lt;/p&gt;
&lt;?php if(something is added in here then what?) ?&gt;
</code></pre>
